...
public class TulingTokenEnhancer implements TokenEnhancer {
    ...
    public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        // authentication.getPrincipal()是获取通过com.tuling.tulingmall.service.TulingUserDetailService.loadUserByUsername该方法得到的用户信息
        ...
        //todo 添加扩展的内容，这里暴露memberId到Jwt的令牌中,后期可以根据自己的业务需要 进行添加字段，记得添加的字段是非敏感字段
